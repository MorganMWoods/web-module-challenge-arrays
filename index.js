...
function is31Flavors(bValue){
    console.log(bValue);
}
is31Flavors(Boolean(originalFlavors.length <= 31));
...
removeLastFlavor(originalFlavors.pop());
...
getFlavorByIndex(console.log(originalFlavors[2]));
...
function removeFlavorByName(){
    // originalFlavors.indexOf('Eggnog');
    originalFlavors.splice(15, 1);
    // console.log(originalFlavors.indexOf('Eggnog'));
    console.log(originalFlavors)
}
removeFlavorByName();
